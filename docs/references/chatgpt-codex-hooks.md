---
title: ChatGPT (Codex) Hooks 接入说明
agent: ChatGPT / Codex
source: https://developers.openai.com/codex/hooks
fetched_at: 2026-08-12
notes: 产品表中 ChatGPT 对应 Codex Hooks
---
...
- If `timeout` is omitted, Codex uses `600` seconds for most hooks.`SessionEnd` uses `1` second by default and supports up to `3` seconds.
...
`<temp_dir>/hook_outputs/<session_id>/.txt` and gives the model a
